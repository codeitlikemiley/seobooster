...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            /* tabs */
            tabs: [{ name: 'blog post', component: 'blog-post', icon: 'fa-newspaper-o', iconColor: 'blue-grey' }, { name: 'social post', component: 'social-post', icon: 'fa-share-alt', iconColor: 'light-blue' }, { name: 'video post', component: 'video-post', icon: 'fa-youtube-play ', iconColor: 'red darken-4' }],
            active: {
                name: 'blog post'
            }
        };
