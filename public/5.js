...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_published_BlogPosted_vue__ = __webpack_require__(952);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_published_SocialPosted_vue__ = __webpack_require__(957);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_published_VideoPosted_vue__ = __webpack_require__(962);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            /* tabs */
            tabs: [{ name: 'blog posted', component: 'blog-posted', icon: 'fa-newspaper-o', iconColor: 'amberen-2' }, { name: 'social posted', component: 'social-posted', icon: 'fa-address-book', iconColor: 'cyan' }, { name: 'video posted', component: 'video-posted', icon: 'fa-youtube-play ', iconColor: 'red darken-4' }],
            active: {
                name: 'blog posted'
            }
        };
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(658)("45a84e08", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            { text: 'Campaign Name', value: 'name', align: 'left', sortable: true }, { text: 'Blog Post Title', value: 'title', align: 'left', sortable: true }, { text: 'Platform', value: 'platform', align: 'left', sortable: true }, { text: 'Published At', value: 'published_at', align: 'left', sortable: true }],
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(658)("1209b8e9", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(658)("fd3e4252", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
