...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            /* tabs */
            tabs: [{ name: 'blog failure', component: 'blog-failure', icon: 'fa-newspaper-o', iconColor: 'blue-grey' }, { name: 'social failure', component: 'social-failure', icon: 'fa-share-alt', iconColor: 'light-blue' }, { name: 'video failure', component: 'video-failure', icon: 'fa-youtube-play ', iconColor: 'red darken-4' }],
            active: {
                name: 'blog failure'
            }
        };
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  _vm._v(
                    "\n        You Have No Failured Scheduled Post Yet On Blog Type Post...\n      "
                  )
                ]
              )
            ],
