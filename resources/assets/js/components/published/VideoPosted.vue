    ...
    >
        ...
        <template slot="items" slot-scope="props">
                ...
                <td class="title text-xs-center">
                     <v-btn flat icon color="cyan" :href="props.item.link" target="_blank">
                    <v-icon>fa-eye</v-icon>
                    </v-btn>
                    <v-btn flat icon color="accent" @click="editPost(props.item)">
...
export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Video Post Title', value: 'title', align: 'center', sortable: true },
