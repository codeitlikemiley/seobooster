...
<v-card>
    ...
    >
        ...
        <template slot="items" slot-scope="props">
                ...
                <td class="title text-xs-center primary--text">
                    <v-btn icon :class="{'green lighten-2': props.item.smart_rank === 'on', 'red lighten-2': props.item.smart_rank === 'off'}" dark>{{ props.item.smart_rank }}</v-btn>
                </td>
                <td class="title text-xs-center primary--text">
                    <v-btn icon :class="{'green lighten-2': props.item.smart_rank === 'on', 'red lighten-2': props.item.smart_rank === 'off'}" dark>{{ props.item.status }}</v-btn>
                </td>
                <td class="title text-xs-center primary--text">
                    <v-btn color="accent" outline dark @click="viewActivities(props.item)">Activities</v-btn>
                </td>
                <td class="title text-xs-center">
                    <v-btn flat icon color="accent" @click.native="editItem(props.item)">
